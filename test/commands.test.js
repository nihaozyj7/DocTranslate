...
suite('Commands Test Suite', () => {
    ...
    test('registerCommands should initialize showTranslated from global state', () => {
    ...
    test('registerCommands should register toggleMode command', () => {
        const mockContext = new MockExtensionContext();
    ...
    test('registerCommands should register retranslate command', () => {
        const mockContext = new MockExtensionContext();
        const registerCommandSpy = sandbox.spy(vscode.commands, 'registerCommand');
        (0, commands_1.registerCommands)(mockContext);
    ...
    test('registerCommands should register showCache command', () => {
        const mockContext = new MockExtensionContext();
        const registerCommandSpy = sandbox.spy(vscode.commands, 'registerCommand');
        (0, commands_1.registerCommands)(mockContext);
